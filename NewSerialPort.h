/* Arduino NewSerialPort Library
 * Copyright (C) 2011 by William Greiman
 *
 * This file is part of the Arduino NewSerialPort Library
 *
 ...
 * along with the Arduino NewSerialPort Library.  If not, see
 * <http://www.gnu.org/licenses/>.
 */
  /**
 * \file
 * \brief NewSerialPort class
 */
#ifndef NewSerialPort_h
#define NewSerialPort_h
//------------------------------------------------------------------------------
/** NewSerialPort version YYYYMMDD */
 ...
 * RxBufSize must be zero in all NewSerialPort constructors if
 * BUFFERED_RX is zero.
 */
 ...
 * TxBufSize must be zero in all NewSerialPort constructors if
 * BUFFERED_TX is zero.
 */
...
#define USE_NEW_SERIAL NewSerialPort<0, 63, 63> NewSerial
/** Define NewSerial1 with buffering like Arduino 1.0. */
#define USE_NEW_SERIAL1 NewSerialPort<1, 63, 63> NewSerial1
/** Define NewSerial2 with buffering like Arduino 1.0. */
#define USE_NEW_SERIAL2 NewSerialPort<2, 63, 63> NewSerial2
/** Define NewSerial3 with buffering like Arduino 1.0. */
#define USE_NEW_SERIAL3 NewSerialPort<3, 63, 63> NewSerial3
//------------------------------------------------------------------------------
#include <avr/io.h>
...
class NewSerialPort : public Stream {
 public:
  //----------------------------------------------------------------------------
  NewSerialPort() {
